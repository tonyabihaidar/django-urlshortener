...
# Comma-separated hostnames, e.g. "127.0.0.1,localhost,mydomain.com"
...
# Let WhiteNoise manage static file compression & caching
...
LOGOUT_REDIRECT_URL = 'shortener:login'
